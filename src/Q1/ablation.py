...
用法 / Usage:
    ...
    python -m Q1.ablation --experiments baseline,no_bn
    python -m Q1.ablation --ignore-search       # 忽略搜索结果
"""
...
def main() -> None:
    ...
    run_ablation_main("Q1", load_q1_best_params, args)
