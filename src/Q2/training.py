"""
ResNet-18 训练管线。
ResNet-18 training pipeline using skorch.
...
def train_resnet(
    ...
    """
    完整的 ResNet-18 skorch 训练管线。
    Full ResNet-18 skorch training pipeline.

    使用 skorch NeuralNetClassifier 包装 ResNet-18，自动配置:
